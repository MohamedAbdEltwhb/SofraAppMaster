...
public class OffesAdapter extends RecyclerView.Adapter<OffesAdapter.OffersHolder> {

    private Context mContext;
    private List<RestaurantOfferDatum> mOffersDatumList;

    public OffesAdapter(Context mContext, List<RestaurantOfferDatum> offersDatumList) {
    ...
    public void onBindViewHolder(@NonNull OffersHolder holder, int position) {
        RestaurantOfferDatum offersDatum = mOffersDatumList.get(position);
