...
public class RegisterData {
    ...
    public RegisterData(String name, String email, String phone, String whatsapp, String regionId, String deliveryCost,
                        String minimumCharger, String availability, Integer id, String photoUrl, String region) {
        this.name = name;
        this.email = email;
        this.phone = phone;
