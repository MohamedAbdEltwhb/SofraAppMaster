...
public class CitesSpinnerAdapter extends ArrayAdapter<CitesObject> {


    public CitesSpinnerAdapter(@NonNull Context context, List<CitesObject> customList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        CitesObject item = getItem(position);
